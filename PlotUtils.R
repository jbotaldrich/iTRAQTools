...
NormPlot <- function (T_Data, output = "null", filename = "default", issaved = TRUE) {
  if(issaved){
  originald <- getwd()
...
VolPlot <- function(inDatax, inDatay, output, maxy = NULL, filename = "default", issaved = TRUE)
{
...
# in upper right
PairPlot <- function(inData, output = "null", filename = "default", issaved = TRUE)
{
  if(issaved)
  {
  originald <- getwd()
